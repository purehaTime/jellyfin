...
namespace MediaBrowser.Controller.MediaEncoding
{
    public interface IEncodingManager
    {
        ...
        Task<bool> RefreshChapterImages(Video video, IReadOnlyList<ChapterInfo> chapters, bool extractImages, bool saveChapters, CancellationToken cancellationToken);
    }
}
